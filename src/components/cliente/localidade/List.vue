<template>
  ...
  <v-layout row>
    <v-flex xs16 sm6 offset-sm3>
      <v-card>
        <v-card-title>
            <v-icon large v-badge="{ value: items.length }" class="grey--text red--after">location_city</v-icon>
            {{ title }}
            <v-spacer></v-spacer>
        ...
        <v-list two-line>
          <v-list-item v-for="(item, index) in items" v-bind:key="item.nome" v-bind:search="search">
            <template slot="items" scope="props">
            <v-list-tile avatar ripple>
              <v-list-tile-content>
                <v-list-tile-title>{{ props.item.nome }}</v-list-tile-title>
                <v-list-tile-sub-title class="grey--text text--darken-4">{{ props.item.tipo }}</v-list-tile-sub-title>
                <v-list-tile-sub-title>{{ props.item.municipio }}</v-list-tile-sub-title>
              </v-list-tile-content>
              <v-list-tile-action>
                <v-list-tile-action-text>{{ props.item.ativo }}</v-list-tile-action-text>
